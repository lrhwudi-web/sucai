...
export function CatalogSheet({products,search,onSearchChange,draft,publishedCatalogDraft,loading,loadError,storageFailed,onRetry,onUpdate,onToggle,onEdit,onNotify,onOpenDrive,onSetCover,onUndo,onRedo,canUndo,canRedo,catalogOrderOwner,canManageCatalogOrder,catalogOrderLoading,catalogOrderSaving,catalogOrderError,onSaveCatalogOrder,onSaveCatalogOrderOnly}:Props){
